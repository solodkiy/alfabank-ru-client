...
class AlfaBankApiClient
{
    ...
    {
        $result = $this->makeRequest('https://web.alfabank.ru/newclick-operations-history-ui/proxy/operations-history-api/operations/' . rawurlencode($transactionId));
    ...
    private function makeGetOperationsRequest(int $page, int $pageSize, string $account, string $from, string $to): array
    {
        ...
        $pageData = $this->makeRequest(
            'https://web.alfabank.ru/newclick-operations-history-ui/proxy/operations-history-api/operations',
            $request
        );
